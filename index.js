...
let resp_json = {nome: "Matheus pimentel", idade: 26};
  ...
  app.put('/webhook', function(req, res) {
        ...
        if(req.body.tipo == 'transacao_documento'){
          ...
          console.log('Pagamento e recebimento de boleto!');
          ...
          const mailOptions = {
            from: 'sac@sgnsistemas.com.br',
            to: 'matheus.007brasil@gmail.com',
            subject: 'E-mail enviado sobre o recebimento de boleto de pagamento!',
            text: 'Vamos pagar as contas? Receba este boleto!'
          };
